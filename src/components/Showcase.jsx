    ...
    <section className="bg-[#060f07]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0.5 lg:gap-0">
        ...
        <div className="flex flex-col">
          ...
          {/* Quote panel */}
          <div className="flex-1 flex flex-col justify-center px-8 sm:px-10 lg:px-12 py-10 bg-[#0a1a0c]">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-gray-400">The NaijaKoblas Promise</p>
            </div>
          </div>
        </div>
      </div>
